...
<head>
  ...
  <title>Global Jaya &mdash; Register</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ url('backend/assets/node_modules/bootstrap-social/bootstrap-social.css') }}">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ url('assets/logo1.png') }}" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('register') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control @error('name') is-invalid @enderror" name="password" tabindex="2" required autocomplete="new-password">
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="simple-footer">
              Copyright &copy; Global Jaya 2021
            </div>
          </div>
        </div>
      </div>
